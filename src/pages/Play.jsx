                ...
                <section className="bg-riverside-teal text-white p-12 rounded-[3rem] mb-12 relative overflow-hidden">
                    ...
                    <div className="relative z-10 max-w-2xl">
                        ...
                        <p className="text-lg opacity-90 mb-8">
                            From the adrenaline rush of bumping cars to the focused energy of indoor cricket, Jaan Entertainment Pvt Ltd offers a state-of-the-art recreation zone for all ages.
                        </p>
